...
const { register, login, google_failure, google_success, facebook_failure,facebook_success, parseSocial, generate_verify, verify } = require('../controllers/user')
...
userRouter.get('/generate-verify/:id', generate_verify)
